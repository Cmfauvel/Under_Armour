...
var searchBar = document.querySelector(".input__search--mobile");
...
var menuIcons = document.querySelector('.menu__icons');
var iconUser = document.querySelector('.icon__user');
var menuMobile = document.querySelector('.menu--mobile');
var iconMenuFerme = document.querySelector('.menu__icon');
var iconMenuOuvert = document.querySelector('#menu--ouvert');
iconMenuFerme.addEventListener("click", function (event) {
...
iconMenuOuvert.addEventListener("click", function (event) {
...
var titresMenuDesktop = document.getElementsByClassName('element__listmenu');
var soustitreMenuDesktop = document.getElementsByClassName('subtitle');

var _loop = function _loop(i) {
  titresMenuDesktop[i].addEventListener("mouseover", function (event) {
    soustitreMenuDesktop[i].classList.remove("hide");
    mainDark.classList.add("dark");
    soustitreMenuDesktop[i].addEventListener("mouseover", function (event) {
      soustitreMenuDesktop[i].classList.remove("hide");
      mainDark.classList.add("dark");
    });
    soustitreMenuDesktop[i].addEventListener("mouseout", function (event) {
      soustitreMenuDesktop[i].classList.add("hide");
      mainDark.classList.remove("dark");
    });
  });
  titresMenuDesktop[i].addEventListener("mouseout", function (event) {
    soustitreMenuDesktop[i].classList.add("hide");
    mainDark.classList.remove("dark");
  });
};

for (var i = 0; i < titresMenuDesktop.length; i++) {
  _loop(i);
}

; //__________________CAROUSEL DESKTOP

var currentSlide = document.querySelector('.slide');
var nextArrow = document.querySelector('#next__slide');
var previousArrow = document.querySelector('#previous__slide');
var nextSlide = currentSlide.nextElementSibling; // let slides = document.getElementsByClassName('slide_img');
...
var contentTendanceMobile = document.querySelector(".content_four_column_mobile");
var contentTendanceDesktop = document.querySelector(".content_four_column");
var contentListeMobile = document.querySelectorAll(".content_liste");
var contentTitleMobile = document.querySelectorAll(".content_column_title_mobile");
var footerMobileContent = document.querySelector(".footer_mobile_content");
var footerDesktopContent = document.querySelector(".footer_desktop_content");
...
function changeClassForMobile(e) {
  if (e.matches) {
    ...
    var _loop2 = function _loop2(_i) {
      var title = contentTitleMobile[_i];
      var ul = title.nextElementSibling;
      var iconPlus = title.children[0];
      var iconMinus = title.children[1];
    ...
    for (var _i = 0; _i < contentTitleMobile.length; _i++) {
      _loop2(_i);
    }
  } else {
